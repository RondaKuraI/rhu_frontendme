...
<template>
    <v-app id="inspire">
      <v-navigation-drawer v-model="drawer" color="teal-accent-4" app>
  ...
  <v-app theme="light">
    <v-navigation-drawer v-model="isDrawerOpen" color="teal-accent-4">
      ...
      <v-list>
        ...
        <v-list-item to="/dashboard/appointment" prepend-icon="mdi-calendar">Appointment</v-list-item>
        <v-list-item to="/records" prepend-icon="mdi-folder">Records</v-list-item>
        <!--
    ...
    export default {
      ...
      data: () => ({
        ...
        links: [
          ...
          ['mdi-calendar-multiselect', 'Appointment'],
          ['mdi-folder', 'Records'],
        ],
      }),
      */
